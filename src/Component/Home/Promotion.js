                                    ...
                                    backgroundColor: "#f3f3f3",textAlign:'left', padding:'70px' }}>
                                        <CardContent>
                                            <div style={{ fontWeight: "bold" }}>
                                                ...
                                                <TaskAltIcon sx={{ fontSize: 40, color:'green' }}></TaskAltIcon> <br/> VOTED NO 1 <br/>REALTOR IN THE BAY
                                                </Typography>                                       
                                            </div>
                                        </CardContent>
                                    </Card>
                                ...
                                >
                                    ...
                                    backgroundColor: "white",textAlign:'left', padding:'70px' }}>
                                        <CardContent>
                                            <div style={{ fontWeight: "bold" }}>
                                                <Typography gutterBottom variant="label" component="div" style={{ fontWeight: "bold", fontFamily: 'OpenSansHebrewCondensed-Bold', fontSize:'30px' }}>
                                                <TextSnippetIcon sx={{ fontSize: 40, color:'orange' }}></TextSnippetIcon> <br/> FREE REGISTRATION <br/> NO HIDDEN FEES
                                                </Typography>                                       
                                            </div>
                                        </CardContent>
                                    </Card>
                                ...
                                >
                                    ...
                                    backgroundColor: "white",textAlign:'left', padding:'70px' }}>
                                        <CardContent>
                                            <div style={{ fontWeight: "bold" }}>
                                                <Typography gutterBottom variant="label" component="div" style={{ fontWeight: "bold", fontFamily: 'OpenSansHebrewCondensed-Bold', fontSize:'30px' }}>
                                                <TableRowsIcon sx={{ fontSize: 40, color:'purple' }}></TableRowsIcon> <br/> FREE PROPERTY <br/> VALUATION
                                                </Typography>                                       
                                            </div>
                                        </CardContent>
                                    </Card>
                                ...
                                >
                                    ...
                                    backgroundColor: "#f3f3f3",textAlign:'left', padding:'70px' }}>
                                        <CardContent>
                                            <div style={{ fontWeight: "bold" }}>
                                                <Typography gutterBottom variant="label" component="div" style={{ fontWeight: "bold", fontFamily: 'OpenSansHebrewCondensed-Bold', fontSize:'30px' }}>
                                                <FmdGoodIcon sx={{ fontSize: 40, color:'maroon' }}></FmdGoodIcon> <br/> OFFICES IN 4 <br/>LOCATIONS
                                                </Typography>                                       
                                            </div>
                                        </CardContent>
                                    </Card>
