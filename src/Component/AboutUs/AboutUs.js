                        ...
                        <Grid xs={12} md={8} >
                            ...
                            <div style={{ textAlign: "left", margin: '10px' }}>
                                <label style={{ color: "black", fontSize: "20px", fontFamily: 'OpenSansHebrewCondensed-Regular' }}>
                                    Dream Estate is one of the most highly ambitious and performance driven Real estate broker group in the Philippine market.
                                    Dream Estate's story is one that aims to bring growth to our clients, we believe with our combined work ethic we can help
